<h2><a href="https://practice.geeksforgeeks.org/problems/flood-fill-algorithm1856/1?page=1&category[]=DFS&sortBy=submissions">Flood fill Algorithm</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">An&nbsp;<code>image</code>&nbsp;is represented by a 2-D array of integers, each integer representing the pixel value of the image.</span></p>
