<h2><a href="https://practice.geeksforgeeks.org/problems/permutations-of-a-given-string-1587115620/1?page=1&category[]=Recursion&sortBy=submissions">String Permutations</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a string S. The task is to find all permutations of a given string.</span></p>
